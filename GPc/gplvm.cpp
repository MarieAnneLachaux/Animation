...
void CClgplvm::learn()
{
  ...
  {
    cout<<"labelledIndicesFlag==true"<<endl;
  ...
  if(labelsProvided)//ENTERED
  {
    cout<<"labelsProvided==true"<<endl;
  ...
  else if(hasBack)//problemmark
  {
    ...
    if (hasDyn) {
      ...
      cout << "In line 539, hasDyn is FALSE latentDim = "<<latentDim<<"verbosity = "<< getVerbosity() << endl;
...
void CClgplvm::gnuplot()
{
  ...
  else//PLACE TO LOOK AT, HOW TO GET X
  {
