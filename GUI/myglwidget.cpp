...
void myGLwidget::initializeGL(){
    glShadeModel(GL_SMOOTH);
        ...
        arbre.loadBVH(":/bvh/walk_turn_180.bvh");
}
...
void myGLwidget::paintGL(){
    ...
    int m =0;
       ...
       //}
        ...
        cout<<"position noeud 3"<<endl;
        cout<<arbre.N[3]->rotation[0]<<endl;
        cout<<arbre.N[3]->rotation[10]<<endl;
        cout<<arbre.N[3]->rotation[100]<<endl;
