...
myGLwidget::myGLwidget(int framesPerSecond, QWidget *parent, char *name,int load): QOpenGLWidget(parent)
{
    load=load;
    ...
    arbre.centerAndScaleToUnit();
    cout<<arbre.N[10]->p[15]<<endl;
    }

    else {
     arbre.loadBVH("/Users/etcheverrymayalen/TRAVAIL/TELECOM_2A/IGR205/InverseKinematics/data/walk_turn_180.bvh");

     arbre.loadTXT("/Users/etcheverrymayalen/TRAVAIL/TELECOM_2A/IGR204/Kinematics/exampleoutput-3.txt");
